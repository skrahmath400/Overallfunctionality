...
const Footer = () => {
  ...
  const handleMenuClick = (name, route) => {
    try {
      setActiveItem(name); // Set active item on click
      if (route) {
